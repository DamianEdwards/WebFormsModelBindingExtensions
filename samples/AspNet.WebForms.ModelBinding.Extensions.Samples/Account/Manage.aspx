<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="AspNet.WebForms.ModelBinding.Extensions.Samples.Account.Manage" %>
