<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="AspNet.WebForms.ModelBinding.Extensions.Samples.Account.OpenAuthProviders" %>
